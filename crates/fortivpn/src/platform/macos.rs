...
/// On macOS this is a raw file descriptor plus the device name.
...
pub fn parse_gateway_output(stdout: &str) -> Option<Ipv4Addr> {
...
pub fn build_dns_script(dns_servers: &[Ipv4Addr], search_domain: &Option<String>) -> String {
...
pub fn get_ipv6_active_interfaces() -> Vec<String> {
